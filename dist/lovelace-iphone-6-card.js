          ...
          <ha-card .hass="${this._hass}" .config="${this._config}" class="background" style="${this.style.background}" @click="${() => this.fireEvent('hass-more-info')}">
            <div class="content" >
                ...
                <div class="grid-container">
                  <div class="icon"><img class="device-type image-invert" src="/hacsfiles/iphone-6-card/device_type.png" alt="Type" /></div>
                  <div class="text"><span>${this.getValueState('device_type')}</span></div>
                </div>
                ${this.state.showSim ? html`
                <div class="grid-container">
                  <div class="icon"><img class="sim image-invert" src="/hacsfiles/iphone-6-card/sim_1.png" alt="Sim1" /></div>
                  <div class="text"><span>${this.getValueState('sim_1')}</span></div>
                </div>` : null}

                ${this.state.showWifi ? html`
                <div class="grid-container">
                  <div class="icon"><img class="wifi image-invert" src="/hacsfiles/iphone-6-card/wifi.png" alt="WiFi" /></div>
                  <div class="text"><span>${this.getValueState('wifi_on')}</span></div>
                </div>` : null}

                <div class="battery-box" >
                  <img class="battery image-invert" src="/hacsfiles/iphone-6-card/battery.png" alt="Bat" />
